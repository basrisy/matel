<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <?php foreach($tentang_kami->result() as $key) : ?>
        <form class="form" action="" method="post" enctype="multipart/form-data" role="form">
            ...
            <textarea name="tentang_kami" class="ckeditor" id="ckedtor"><?php echo $key->konten;?></textarea>
        
            <div class="ln_solid"></div>
            <div class="form-group">
                <button class="btn btn-primary" name="submit" value="Submit" type="submit"><i class="fa fa-save"></i> Simpan&nbsp;</button>
                <a href="<?= base_url(); ?>utility/tentang_kami" type="button" class="btn btn-dark"> Batal</a>
            </div>
        </form>
        <?php endforeach; ?>
    </div>
